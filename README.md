...
* **puppeteers_keycloak_k3s_enabled_features**: a list of features to enable. Defaults to ['scripts'].

Ingress route configurations are:

* **puppeteers_keycloak_k3s_admin_allow_ips**: IP or IP ranges (IPv4 or IPv6) from which to allow connections to the /admin, /health and /metrics. Defaults to any IPv4 address (0.0.0.0/0).
